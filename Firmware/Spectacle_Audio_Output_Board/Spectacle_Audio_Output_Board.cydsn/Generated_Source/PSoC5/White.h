...
*/
     ...
     *  @{
     */
        #define White_INTR_NONE      (uint16)(0x0000u)
        #define White_INTR_RISING    (uint16)(0x0001u)
        #define White_INTR_FALLING   (uint16)(0x0002u)
        #define White_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define White_INTR_MASK      (0x01u) 
#endif /* (White__INTSTAT) */
...
/* SIO registers */
#if defined(White__SIO_CFG)
    #define White_SIO_HYST_EN        (* (reg8 *) White__SIO_HYST_EN)
    #define White_SIO_REG_HIFREQ     (* (reg8 *) White__SIO_REG_HIFREQ)
    #define White_SIO_CFG            (* (reg8 *) White__SIO_CFG)
    #define White_SIO_DIFF           (* (reg8 *) White__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define White_0_INTTYPE_REG 		(* (reg8 *) White__0__INTTYPE)
#endif /* (White__INTSTAT) */
