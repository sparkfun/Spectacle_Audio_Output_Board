// ======================================================================
// Spectacle_Audio_Output_Board.v generated from TopDesign.cysch
// 07/05/2016 at 15:11
...
module emFile_v1_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("1b25383c-8a63-494f-b64d-e2a520b32709/ed092b9b-d398-4703-be89-cebf998501f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("1b25383c-8a63-494f-b64d-e2a520b32709/5ed615c6-e1f0-40ed-8816-f906ef67d531"),
	...
	cy_psoc3_pins_v1_10
		#(.id("1b25383c-8a63-494f-b64d-e2a520b32709/1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1b25383c-8a63-494f-b64d-e2a520b32709/ae249072-87dc-41aa-9405-888517aefa28"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1b25383c-8a63-494f-b64d-e2a520b32709/6df85302-e45f-45fb-97de-4bdf3128e07b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__RXI_net;
	wire [0:0] tmpIO_0__RXI_net;
	wire [0:0] tmpINTERRUPT_0__RXI_net;
	electrical [0:0] tmpSIOVREF__RXI_net;
	...
	cy_psoc3_pins_v1_10
		...
		RXI
		 (.oe(tmpOE__RXI_net),
		  .y({1'b0}),
		  .fb({Net_7}),
		  .io({tmpIO_0__RXI_net[0:0]}),
		  .siovref(tmpSIOVREF__RXI_net),
		  .interrupt({tmpINTERRUPT_0__RXI_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RXI_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TXO_net;
	wire [0:0] tmpFB_0__TXO_net;
	wire [0:0] tmpIO_0__TXO_net;
	wire [0:0] tmpINTERRUPT_0__TXO_net;
	electrical [0:0] tmpSIOVREF__TXO_net;
	...
	cy_psoc3_pins_v1_10
		...
		TXO
		 (.oe(tmpOE__TXO_net),
		  .y({Net_2}),
		  .fb({tmpFB_0__TXO_net[0:0]}),
		  .io({tmpIO_0__TXO_net[0:0]}),
		  .siovref(tmpSIOVREF__TXO_net),
		  .interrupt({tmpINTERRUPT_0__TXO_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TXO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("6df0a762-4713-4882-b84d-ad46bf3ff41f"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3f3e0eac-649f-429c-a717-887115b18d65"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__MCLK_net;
	wire [0:0] tmpFB_0__MCLK_net;
	wire [0:0] tmpIO_0__MCLK_net;
	wire [0:0] tmpINTERRUPT_0__MCLK_net;
	...
	cy_psoc3_pins_v1_10
		...
		MCLK
		 (.oe(tmpOE__MCLK_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__MCLK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MCLK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("db7f5ca7-3eb8-4393-a623-1577c40065b5"),
    ...
    Timer_v2_70_3 Audio_Timer (
        ...
        .tc(Net_71),
        .clock(Net_10));
    defparam Audio_Timer.CaptureCount = 2;
    defparam Audio_Timer.CaptureCounterEnabled = 0;
    defparam Audio_Timer.DeviceFamily = "PSoC5";
    defparam Audio_Timer.InterruptOnCapture = 0;
    defparam Audio_Timer.InterruptOnTC = 1;
    defparam Audio_Timer.Resolution = 16;
    defparam Audio_Timer.SiliconRevision = "0";
	...
	cy_psoc3_pins_v1_10
		#(.id("fb7735e2-1c39-4a8b-b024-89ea9dad79ff"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("3e9b79cf-e335-4a83-ba09-4f4fde79d5ee"),
	...
	cy_clock_v1_0
		#(.id("cf6172bb-dea4-48d9-aab5-6b02155be2c3"),
		  .source_clock_id("46B167E3-1786-4598-8688-AACCF18668D4"),
		  .divisor(4),
		  .period("0"),
		  .is_direct(0),
    ...
    I2S_v2_70_4 I2S (
        ...
        .tx_dma0(Net_499[0:0]),
        .tx_dma1(Net_500[0:0]),
        .rx_interrupt(Net_501),
        .tx_interrupt(Net_502),
        .clip(Net_503[0:0]));
	...
	cy_psoc3_pins_v1_10
		#(.id("8924b86a-4900-40c4-8de0-50d18b19b5b0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
